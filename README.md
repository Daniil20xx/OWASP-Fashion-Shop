# OWASP-Fashion-Shop
A training web application “Clothing Store” on Go with three intentional OWASP vulnerabilities: SQL Injection, XSS and SSRF. The application is run in Docker, secure PoC exploits are created for each vulnerability, the causes of the problems are analyzed and recommendations on how to fix them are given.
